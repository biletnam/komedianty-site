...
playbill = {
	...
	'2014-12-19-19':'Страсти по-итальянски'
	...
	'2015-01-03-18':'Если поженились, значит, жить придется!'
	'2015-01-04-18':'Если поженились, значит, жить придется!'
	'2015-01-05-18':'Беда от нежного сердца'
	'2015-01-07-18':'Дачницы'
	'2015-01-08-18':'Марлен, рожденная для любви'
	'2015-01-09-18':'Страсти по-итальянски'
	'2015-01-10-18':'Лес'
	'2015-01-11-18':'Земляки'
	'2015-01-15-18':'Сирано де Бержерак'
	'2015-01-16-19':'Не всякий вор — грабитель'
	'2015-01-17-18':'Если поженились, значит, жить придется!'
	'2015-01-18-18':'Страсти по-итальянски'
	'2015-01-21-19':'Поминальная молитва'
	'2015-01-22-19':'Земляки'
	'2015-01-23-19':'Компромисс'
	'2015-01-24-18':'Крепостная любовь (Муму)'
	'2015-01-25-18':'Марлен, рожденная для любви'
	'2015-01-28-19':'Провинциальные анекдоты'
	'2015-01-29-19':'В Париж!'
	'2015-01-30-19':'Дурочка'
	'2015-01-31-19':'Прогулка в Лю-Блё'
}
...
_(playbill).forEach (event, date) ->
	...
	postmeta.event_date = moment(date, 'YYYY-MM-DD-HH').format('YYYY-MM-DD-HH')
	...
	write YAML.stringify(postmeta), metapath, true
	write '', cpath